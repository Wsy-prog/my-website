    ...
    <div className="max-w-3xl mx-auto px-4 py-20">
      ...
      <AnimatedSection delay={0.1}>
        <GlassCard className="p-6 mb-10">
          <form onSubmit={handleSubmit} className="space-y-4" onClick={(e) => e.nativeEvent.stopPropagation()}>
            <Input
              placeholder="你的昵称"
              value={form.name}
...
function ReplyForm({ onSubmit, parentName }: { onSubmit: (name: string, content: string) => void; parentName: string }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex gap-2 items-start" onClick={(e) => e.nativeEvent.stopPropagation()}>
      <Input
        placeholder="你的昵称"
        value={name}
